...
public class luozhuangpaipanshisheng {
	...
	String[][] shisheng = { { "日/干", "甲", "乙", "丙", "丁", "戊", "己", "庚", "辛", "壬", "癸" },
	...
	String[][] shengwang = { { "天干", "长生", "沐浴", "冠带", "临官", "帝旺", "衰", "病", "死", "墓", "绝", "胎", "养" },
	...
	private String paipan(Calendar cal, luozhuanglvhehun.sex isman) throws ParseException {
		...
		for (int i = 0; i < DayunArray.length; i++) {
			DayunArrayshengsi[i] = shengwang[0][myLuozhuangpaipandayun.getyuezhuStart(shengwang[shengsibiaoshunxu],
					DayunArray[i].substring(1, 2))]; // 十天干生旺死绝表 用干查表

			DayunArrayshisheng[i] = shisheng[shishengbiaoshunxu][myLuozhuangpaipandayun.getyuezhuStart(shisheng[0],
					DayunArray[i].substring(0, 1))]; // 十神表 用支查表
		}

...
public class LuozhuangshenshaHehun {
	...
	public final String[][] numsix = {
			...
			{ "庚辰", "白蜡金", "7", "9", "6" }, { "己卯", "城墙土", "8", "1", "5" }, { "戊寅", "城墙土", "9", "2", "4" },
			...
			{ "癸丑", "桑松木", "34", "9", "6" }, { "壬子", "桑松木", "35", "1", "5" }, { "辛亥", "钗钏金", "36", "2", "4" },
			{ "庚戌", "钗钏金", "37", "3", "3" }, { "己酉", "大驿土", "38", "4", "2" }, { "戊申", "大驿土", "39", "5", "1" },
			{ "丁未", "天河水", "40", "6", "9" }, { "丙午", "天河水", "41", "7", "8" }, { "乙巳", "佛灯火", "42", "8", "7" },
			{ "甲辰", "佛灯火", "43", "9", "6" }, { "癸卯", "金箔金", "44", "1", "5" }, { "壬寅", "金箔金", "45", "2", "4" },
	...
	Calendar getCalendarfromString(String year, String DateFormat) throws ParseException {
	...
	/**
	 * * 字符串-》数字 * * @param year 字符串 * @return 字符串对应数字 * @throws

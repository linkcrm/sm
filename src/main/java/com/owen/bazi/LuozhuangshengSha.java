...
public class LuozhuangshengSha {
	...
	public String[] jiazi = { "　", "甲子", "乙丑", "丙寅", "丁卯", "戊辰", "己巳", "庚午", "辛未", "壬申", "癸酉", "甲戌", "乙亥", "丙子", "丁丑",
			"戊寅", "己卯", "庚辰", "辛巳", "壬午", "癸未", "甲申", "乙酉", "丙戌", "丁亥", "戊子", "己丑", "庚寅", "辛卯", "壬辰", "癸巳", "甲午", "乙未",
			"丙申", "丁酉", "戊戌", "己亥", "庚子", "辛丑", "壬寅", "癸卯", "甲辰", "乙巳", "丙午", "丁未", "戊申", "己酉", "庚戌", "辛亥", "壬子", "癸丑",
	...
	private String[] liunianshensha(int[] yearintarray, String[] yeararray, String[] bazi, luozhuanglvhehun.sex isman) {
		...
		for (int i2 = 0;; i2++) {
			...
			returnarray[i2] = (yearintarray[i2] + yeararray[i2] + "　　神煞：" + shengshadayun(yeararray[i2], bazi, isman)
					+ "\n");
		}
	}
	 ...
	 *            年分八字
	 * @param bazi
	 *            此人八字四柱 arrayOfString[1] = bazi[1];//年干 arrayOfString[2] =
	 *            bazi[2];//年支 arrayOfString[3] = bazi[3];//月干 arrayOfString[4]
	 *            = bazi[4];//月支 arrayOfString[5] = bazi[5];//日干
	 *            arrayOfString[6] = bazi[6];//日支 arrayOfString[7] =
	 *            bazi[7];//时干 arrayOfString[8] = bazi[8];//时支
	 * @param isman
	 *            男人么
	 * @return 神煞
	 */
	public String shengshadayun(String yearjiazi, String[] bazi, luozhuanglvhehun.sex isman) {
		String returnString = "";
		if ((tianyiguiren(bazi[5], yearjiazi.substring(1, 2)) == 1)
				|| (tianyiguiren(bazi[1], yearjiazi.substring(1, 2)) == 1)) {
			returnString += "天乙 ";

		}
		if ((taijiguiren(bazi[5], yearjiazi.substring(1, 2)) == 1)
				|| (taijiguiren(bazi[1], yearjiazi.substring(1, 2)) == 1)) {
			returnString += "太极 ";

		}
		if ((tiandeguiren(bazi[4], yearjiazi.substring(0, 1)) == 1)
				|| (tiandeguiren(bazi[4], yearjiazi.substring(1, 2)) == 1)) {
			returnString += "天德 ";
		...
		if ((wenchang(bazi[5], yearjiazi.substring(1, 2)) == 1)
				|| (wenchang(bazi[1], yearjiazi.substring(1, 2)) == 1)) {
			returnString += "文昌 ";
		...
		if ((jiangxing(bazi[6], yearjiazi.substring(1, 2)) == 1)
				|| (jiangxing(bazi[2], yearjiazi.substring(1, 2)) == 1)) {
			returnString += "将星 ";
		...
		if ((kongwang(bazi[5] + bazi[6], yearjiazi.substring(1, 2)) == 1)
				|| (kongwang(bazi[1] + bazi[2], yearjiazi.substring(1, 2)) == 1)) {
			returnString += "空亡 ";
		...
		if ((shangmen(bazi[6], yearjiazi.substring(1, 2)) == 1)
				|| (shangmen(bazi[2], yearjiazi.substring(1, 2)) == 1)) {
			returnString += "丧门 ";
	 ...
	 * @return
	 */
	public boolean isGuaxiu(String nz, String dz, String tg, boolean isNz) {
		String tgdz = tg + dz;
		if ("子".equals(nz)) {
			if (tgdz.contains("戌")) {
				return true;
	 ...
	 * @return
	 */
	public boolean isGuchen(String nz, String dz, String tg, boolean isNz) {
		String tgdz = tg + dz;
		if ("子".equals(nz)) {
			if (tgdz.contains("寅")) {
				return true;
	 ...
	 * @return
	 */
	public boolean isTianxi(String nz, String dz, String tg, boolean isNz) {
		String tgdz = tg + dz;
		if ("子".equals(nz)) {
			if (tgdz.contains("酉")) {
				return true;
	 ...
	 * @return
	 */
	public boolean isHongluan(String nz, String dz, String tg) {
		String tgdz = tg + dz;
		if ("子".equals(nz)) {
			if (tgdz.contains("卯")) {
				return true;
	 ...
	 * @return
	 */
	public boolean isTaohua2(String nz, String dz, String tg, boolean isNz) {
		String tgdz = tg + dz;
		if ("子".equals(nz)) {
			if (tgdz.contains("酉")) {
				return true;
	 ...
	 * @return
	 */
	public boolean isZaisha(String nz, String dz, String tg, boolean isNz) {
		String tgdz = tg + dz;
		if ("子".equals(nz)) {
			if (tgdz.contains("午")) {
				return true;
	 ...
	 * @return
	 */
	public boolean isJiesha2(String nz, String dz, String tg, boolean isNz) {
		String tgdz = tg + dz;
		if ("子".equals(nz)) {
			if (tgdz.contains("巳")) {
				return true;
	 ...
	 * @return
	 */
	public boolean isHuagai2(String nz, String dz, String tg, boolean isNz) {
		String tgdz = tg + dz;
		if ("子".equals(nz)) {
			if (tgdz.contains("辰")) {
				return true;
	 ...
	 * @return
	 */
	public boolean isYima2(String nz, String dz, String tg, boolean isNz) {
		String tgdz = tg + dz;
		if ("子".equals(nz)) {
			if (tgdz.contains("寅") && !isNz) {
				return true;
			}
		}
		if ("丑".equals(nz)) {
	 ...
	 * @return
	 */
	public boolean isJiangxing2(String nz, String dz, String tg, boolean isNz) {
		String tgdz = tg + dz;
		if ("子".equals(nz)) {
			if (tgdz.contains("子") && !isNz) {
				return true;
			}
		}
		if ("丑".equals(nz)) {
	 ...
	 * @return
	 */
	public boolean isYuedehe(String yz, String dz, String tg) {
		String tgdz = tg + dz;
		if ("子".equals(yz)) {
			if (tgdz.contains("丁")) {
				return true;
	 ...
	 * @return
	 */
	public boolean isYuede(String yz, String dz, String tg) {
		String tgdz = tg + dz;
		if ("子".equals(yz)) {
			if (tgdz.contains("壬")) {
				return true;
	 ...
	 * @return
	 */
	public boolean isTiandehe(String yz, String dz, String tg) {
		String tgdz = tg + dz;
		if ("子".equals(yz)) {
			if (tgdz.contains("申")) {
				return true;
	 ...
	 * @return
	 */
	public boolean isTiande(String yz, String dz, String tg) {
		String tgdz = tg + dz;
		if ("子".equals(yz)) {
			if (tgdz.contains("巳")) {
				return true;
	 ...
	 * @return
	 */
	public boolean isJiangxing(String rz, String dz, boolean isRz) {
		if ("子".equals(rz)) {
			if ("子".equals(dz) && !isRz) {
				return true;
			}
	 ...
	 * @return
	 */
	public boolean isWangshen(String rz, String dz) {
		if ("子".equals(rz)) {
			if ("亥".equals(dz)) {
				return true;
			}
	 ...
	 * @return
	 */
	public boolean isJiesha(String rz, String dz) {
		if ("子".equals(rz)) {
			if ("巳".equals(dz)) {
				return true;
			}
	 ...
	 * @return
	 */
	public boolean isTaohua(String rz, String dz) {
		if ("子".equals(rz)) {
			if ("酉".equals(dz)) {
				return true;
			}
	 ...
	 * @return
	 */
	public boolean isHuagai(String rz, String dz, boolean isRz) {
		if ("子".equals(rz)) {
			if ("辰".equals(dz)) {
				return true;
			}
	 ...
	 * @return
	 */
	public boolean isYima(String rz, String dz) {
		if ("子".equals(rz)) {
			if ("寅".equals(dz)) {
				return true;
			}
	 ...
	 * @return
	 */
	public boolean isJinyu(String rg, String dz) {
		if ("甲".equals(rg)) {
			if ("辰".contains(dz)) {
				return true;
			}
	 ...
	 * @return
	 */
	public boolean isHongyan(String rg, String dz) {
		if ("甲".equals(rg)) {
			if ("午申".contains(dz)) {
				return true;
			}
	 ...
	 * @return
	 */
	public boolean isYangren(String rg, String dz) {
		if ("甲".equals(rg)) {
			if ("卯".contains(dz)) {
				return true;
			}
	 ...
	 * @return
	 */
	public boolean isLuShen(String rg, String dz) {
	 ...
	 * @return
	 */
	public boolean isWenchang(String rg, String dz) {
		if ("甲".equals(rg)) {
			if ("巳".contains(dz)) {
				return true;
			}
	 ...
	 * @return
	 */
	public boolean isTianyiGuiren(String rg, String dz) {
		if ("甲".equals(rg)) {
			if ("丑".contains(dz)) {
				return true;
			}
	...
	public boolean is6xiuri(String rg, String rz) {
		String tgdz = rg + rz;
		if (tgdz.equals("丙午") || tgdz.equals("丁未") || tgdz.equals("戊子") || tgdz.equals("戊午") || tgdz.equals("己丑")
				|| tgdz.equals("己未")) {
			return true;
		}
	...
	public boolean isShiLingri(String rg, String rz) {
		String tgdz = rg + rz;
		if (tgdz.equals("甲辰") || tgdz.equals("乙亥") || tgdz.equals("丙辰") || tgdz.equals("丁酉") || tgdz.equals("戊午")
				|| tgdz.equals("庚戌") || tgdz.equals("庚寅") || tgdz.equals("辛亥") || tgdz.equals("壬寅")
				|| tgdz.equals("癸未")) {
			return true;
		}
	 ...
	 * @return
	 */
	public boolean isLiuxia(String rg, String dz) {
		if (rg.equals("甲")) {
			if (dz.equals("酉")) {
				return true;
			}
	...
	public boolean judeGousaYinnan(String nz,String dz) {
		if( "丑".equals(nz) && "辰戌".contains(dz)) {
			return true;
		}
		if( "卯".equals(nz) && "午子".contains(dz) ){
			return true;
		}
		if("巳 ".equals(nz) && "申寅".contains(dz) ){
			return true;
		}
		if( "未".equals(nz) && "戌辰".contains(dz)) {
			return true;
		}
		if( "酉".equals(nz) && "子午".contains(dz) ){
			return true;
		}
		if("亥 ".equals(nz) && "寅申".contains(dz) ){
			return true;
		}
		return false;
	}
	...
	public boolean judeGousaYinnv(String nz,String dz) {
		if( "丑".equals(nz) && "辰戌".contains(dz)) {
			return true;
		}
		if( "卯".equals(nz) && "午子".contains(dz) ){
	...
	public boolean judeGousaYangnv(String nz,String dz) {
		if( "子".equals(nz) && "卯酉".contains(dz)) {
			return true;
		}
		if( "寅".equals(nz) && "巳亥".contains(dz) ){
			return true;
		}
		if("辰 ".equals(nz) && "未丑".contains(dz) ){
			return true;
		}
		if( "午".equals(nz) && "酉卯".contains(dz)) {
			return true;
		}
		if( "申".equals(nz) && "巳亥".contains(dz) ){
			return true;
		}
		if("戌 ".equals(nz) && "未丑".contains(dz) ){
			return true;
		}
		return false;
	}
	public boolean judeGousaYangnan(String nz,String dz) {
		if( "子".equals(nz) && "卯酉".contains(dz)) {
			return true;
		}
		if( "寅".equals(nz) && "巳亥".contains(dz) ){
	 ...
	 * @param isman
	 */
	public List<ArrayList<String>> shengsha(String[] tgArray, String[] dzArray, luozhuanglvhehun.sex isman) {
		List<ArrayList<String>> result = new ArrayList<ArrayList<String>>();

		String rg = tgArray[2], ng = tgArray[0], yg = tgArray[1], sg = tgArray[3];
		String nz = dzArray[0], yz = dzArray[1], rz = dzArray[2], sz = dzArray[3];
		...
		for (int i = 0; i < 4; i++) {
			...
			if (isTianyiGuiren(rg, dz) || isTianyiGuiren(ng, dz)) {
				String tmp = "天乙";
				ss += tmp;
				ss += " ";
				list.add(tmp);
			...
			if (isWenchang(rg, dz) || isWenchang(ng, dz)) {
				String tmp = "文昌";
				ss += tmp;
				ss += " ";
				list.add(tmp);
			...
			if (isYima(rz, dz) || isYima2(nz, dz, tg, isNz)) {
				String tmp = "驿马";
				ss += tmp;
				ss += " ";
				list.add(tmp);
			...
			if (isHuagai(rz, dz, isRz) || isHuagai2(nz, dz, tg, isNz)) {
				String tmp = "华盖";
				ss += tmp;
				ss += " ";
				list.add(tmp);
			...
			if (isTaohua(rz, dz) || isTaohua2(nz, dz, tg, isNz)) {
			...
			if (isJiesha(rz, dz) || isJiesha2(nz, dz, tg, isNz)) {
				String tmp = "劫煞";
				ss += tmp;
				ss += " ";
				list.add(tmp);
			...
			if (isWangshen(rz, dz) || isWangshen(nz, dz)) {
			...
			if (isJiangxing(rz, dz, isRz) || isJiangxing2(nz, dz, tg, isNz)) {
			...
			if (isRz && yingyangchacuo(tg, dz) == 1) {
			...
			if (    yuancheng( nz , dz , Manorwoman(isman), dizhiOrder( nz ) % 2 ) == 1  ){
				//有出入
				String tmp = "元辰";
				ss += tmp;
				ss += " ";
			...
			if(  taijiguiren(ng, dz)  == 1 || taijiguiren(rg, dz)  == 1 ){
			...
			if ((LuozhuangcommonClass.yinyang(nz).equals("阳") && Manorwoman(isman) == 1)
					|| (LuozhuangcommonClass.yinyang(nz).equals("阴") && Manorwoman(isman) == 0)) { // 阳男阴女
				
				if( judeGousaYangnan(nz, dz) || judeGousaYinnv(nz, dz)){
				...
				if( judeGousaYinnan(nz, dz) || judeGousaYangnv(nz, dz) ){
					String tmp = "勾绞煞";
					ss += tmp;
					ss += " ";
					list.add(tmp);
	...
	public String shengsha(String[] bazi, luozhuanglvhehun.sex isman) {
		...
		for (int i1 = 1;; i1++) {
			...
			if ((tianyiguiren(arrayOfString[5], arrayOfString[i1]) == 1)
					|| (tianyiguiren(arrayOfString[1], arrayOfString[i1]) == 1)) {
				returnstring += "天乙 ";// 以日干起贵人, 地支见者为是.
			}

			if ((taijiguiren(arrayOfString[5], arrayOfString[i1]) == 1)
					|| (taijiguiren(arrayOfString[1], arrayOfString[i1]) == 1)) {
				returnstring += "太极 ";
			}
			...
			if ((wenchang(arrayOfString[5], arrayOfString[i1]) == 1)
					|| (wenchang(arrayOfString[1], arrayOfString[i1]) == 1)) {
				returnstring += "文昌 ";
			}
			...
			if ((guoying(arrayOfString[5], arrayOfString[i1]) == 1)
					|| (guoying(arrayOfString[1], arrayOfString[i1]) == 1)) {
				returnstring += "国印 ";

			}

			if ((xuetang(arrayOfString[5], arrayOfString[(i1 - 1)], arrayOfString[i1]) == 1)
					|| (xuetang(arrayOfString[1], arrayOfString[(i1 - 1)], arrayOfString[i1]) == 1)) {
				returnstring += "学堂 ";

			}
			if ((ciguan(arrayOfString[5], arrayOfString[(i1 - 1)], arrayOfString[i1]) == 1)
					|| (ciguan(arrayOfString[1], arrayOfString[(i1 - 1)], arrayOfString[i1]) == 1)) {
				returnstring += "词馆 ";
			...
			if ((huagai(arrayOfString[6], arrayOfString[i1]) == 1)
					|| (huagai(arrayOfString[2], arrayOfString[i1]) == 1)) {
				returnstring += "华盖 ";

			}

			if ((jiangxing(arrayOfString[6], arrayOfString[i1]) == 1)
					|| (jiangxing(arrayOfString[2], arrayOfString[i1]) == 1)) {
				returnstring += "将星 ";
			...
			if (((jingshen(arrayOfString[5], arrayOfString[6]) == 1) && (i1 == 5))
					|| ((jingshen(arrayOfString[7], arrayOfString[8]) == 1) && (i1 == 7))) {
				returnstring += "金神 ";
			...
			if ((tianluo(arrayOfString[6], arrayOfString[i1]) == 1)
					|| (tianluo(arrayOfString[2], arrayOfString[i1]) == 1)) {
				returnstring += "天罗 ";

			}

			if ((diwang(arrayOfString[6], arrayOfString[i1]) == 1)
					|| (diwang(arrayOfString[2], arrayOfString[i1]) == 1)) {
				returnstring += "地网 ";
			...
			if ((jiesha(arrayOfString[6], arrayOfString[i1]) == 1)
					|| (jiesha(arrayOfString[2], arrayOfString[i1]) == 1)) {
				returnstring += "劫煞 ";

			}

			if ((zaisha(arrayOfString[6], arrayOfString[i1]) == 1)
					|| (zaisha(arrayOfString[2], arrayOfString[i1]) == 1)) {
				returnstring += "灾煞 ";
			...
			// public String[] dizhi = {" ", "子", "丑", "寅", "卯", "辰", "巳", "午",
			// "未", "申", "酉", "戌", "亥"};
			// 这里我觉得有点鲛人，庚午年生男, 命前三辰即shunxu-3 应该是卯

			if ((LuozhuangcommonClass.yinyang(arrayOfString[2]).equals("阳") && Manorwoman(isman) == 1)
					|| (LuozhuangcommonClass.yinyang(arrayOfString[2]).equals("阴") && Manorwoman(isman) == 0)) { // 阳男阴女
			...
			if ((yuancheng(arrayOfString[2], arrayOfString[i1], Manorwoman(isman), dizhiOrder(bazi[2]) % 2) == 1)
					&& (i1 >= 4)) {
				returnstring += "元辰 ";

			}
			if ((kongwang(arrayOfString[5] + arrayOfString[6], arrayOfString[i1]) == 1)
					|| (kongwang(arrayOfString[1] + arrayOfString[2], arrayOfString[i1]) == 1)) {
				returnstring += "空亡 ";
			...
			if ((wangshen(arrayOfString[6], arrayOfString[i1]) == 1)
					|| (wangshen(arrayOfString[2], arrayOfString[i1]) == 1)) {
				returnstring += "亡神 ";
			...
			if ((taohua(arrayOfString[6], arrayOfString[i1]) == 1)
					|| (taohua(arrayOfString[2], arrayOfString[i1]) == 1)) {
				returnstring += "咸池 ";
			...
			// 吊客查法：年日支后两位为吊客。
			// 丧门查法：年日支前两位为丧门。
			if (((shangmen(arrayOfString[6], arrayOfString[i1]) == 1)
					|| (shangmen(arrayOfString[2], arrayOfString[i1]) == 1)) && (i1 % 2 == 0)) {
				returnstring += "丧门 ";

			}
			if (((diaoke(arrayOfString[6], arrayOfString[i1]) == 1)
					|| (diaoke(arrayOfString[2], arrayOfString[i1]) == 1)) && (i1 % 2 == 0)) {
				returnstring += "吊客 ";

			}
			if (((pima(arrayOfString[6], arrayOfString[i1]) == 1) || (pima(arrayOfString[2], arrayOfString[i1]) == 1))
					&& (i1 % 2 == 0)) {
				returnstring += "披麻 ";
	...
	public int kongwang(String paramString1, String paramString2) {
		if ((chaxunjiazishunxu(paramString1) <= 10) && ((paramString2.equals("戌")) || (paramString2.equals("亥"))))
			;
		if (((chaxunjiazishunxu(paramString1) > 10) && (chaxunjiazishunxu(paramString1) <= 20)
				&& ((paramString2.equals("申")) || (paramString2.equals("酉"))))
				|| ((chaxunjiazishunxu(paramString1) > 20) && (chaxunjiazishunxu(paramString1) <= 30)
						&& ((paramString2.equals("午")) || (paramString2.equals("未"))))
				|| ((chaxunjiazishunxu(paramString1) > 30) && (chaxunjiazishunxu(paramString1) <= 40)
						&& ((paramString2.equals("辰")) || (paramString2.equals("巳"))))
				|| ((chaxunjiazishunxu(paramString1) > 40) && (chaxunjiazishunxu(paramString1) <= 50)
						&& ((paramString2.equals("寅")) || (paramString2.equals("卯"))))
				|| ((chaxunjiazishunxu(paramString1) > 50)
						&& ((paramString2.equals("子")) || (paramString2.equals("丑"))))) {
			return 1;
		}
		return 0;
	}
	...
	public int taohua(String paramString1, String paramString2) {
		if (((paramString1.equals("申")) || (paramString1.equals("子")) || (paramString1.equals("辰")))
				&& (paramString2.equals("酉"))) {
			return 1;
		}
		if (((paramString1.equals("寅")) || (paramString1.equals("午")) || (paramString1.equals("戌")))
				&& ((paramString2.equals("卯")))) {
			return 1;
		}
		if (((paramString1.equals("巳")) || (paramString1.equals("酉")) || (paramString1.equals("丑")))
				&& ((paramString2.equals("午")))) {
			return 1;
		}

		if (((paramString1.equals("亥")) || (paramString1.equals("卯")) || (paramString1.equals("未")))
				&& (paramString2.equals("子"))) {
			return 1;
		}
	...
	/**
	 * 阴阳差错 丙子, 丁丑, 戊寅, 辛卯, 壬辰, 癸巳, 丙午, 丁未,戊申, 辛酉, 壬戌, 癸亥. 查法: 日柱见者为是. 阴差阳错
	 *
	 * @param paramString1
	 * @param paramString2
	 * @return
	...
	public int yingyangchacuo(String paramString1, String paramString2) {
		if (((paramString1.equals("丙")) && (paramString2.equals("子")))
				|| ((paramString1.equals("丁")) && (paramString2.equals("丑")))
				|| ((paramString1.equals("戊")) && (paramString2.equals("寅")))
				|| ((paramString1.equals("辛")) && (paramString2.equals("卯")))
				|| ((paramString1.equals("壬")) && (paramString2.equals("辰")))
				|| ((paramString1.equals("癸")) && (paramString2.equals("巳")))
				|| ((paramString1.equals("丙")) && (paramString2.equals("午")))
				|| ((paramString1.equals("丁")) && (paramString2.equals("未")))
				|| ((paramString1.equals("戊")) && (paramString2.equals("申")))
				|| ((paramString1.equals("辛")) && (paramString2.equals("酉")))
				|| ((paramString1.equals("壬")) && (paramString2.equals("戌")))
				|| ((paramString1.equals("癸")) && (paramString2.equals("亥")))) {
			return 1;
		}
		return 0;
	}
	...
	public int tianyiguiren(String paramString1, String paramString2) {
		if (((paramString1.equals("甲")) || (paramString1.equals("戊")))
				&& ((paramString2.equals("丑")) || (paramString2.equals("未")))) {
			return 1;
		}
		if ((paramString1.equals("乙"))
				|| (paramString1.equals("己")) && ((paramString2.equals("申")) || (paramString2.equals("子")))) {
			return 1;
		}
		if (((paramString1.equals("丙")) || (paramString1.equals("丁")))
				&& ((paramString2.equals("亥")) || (paramString2.equals("酉")))) {
			return 1;
		}
		if (((paramString1.equals("壬")) || (paramString1.equals("癸")))
				&& ((paramString2.equals("卯")) || (paramString2.equals("巳")))) {
			return 1;
		}
		if (((paramString1.equals("庚")) || (paramString1.equals("辛")))
				&& ((paramString2.equals("午")) || (paramString2.equals("寅")))) {
			return 1;
		}
	...
	public int taijiguiren(String paramString1, String paramString2) {
		if (((paramString1.equals("甲")) || (paramString1.equals("乙")))
				&& ((paramString2.equals("子")) || (paramString2.equals("午")))) {
			return 1;
		}
		if (((paramString1.equals("丙")) || (paramString1.equals("丁")))
				&& ((paramString2.equals("酉")) || (paramString2.equals("卯")))) {
			return 1;
		}
		if (((paramString1.equals("壬")) || (paramString1.equals("癸")))
				&& ((paramString2.equals("申")) || (paramString2.equals("巳")))) {
			return 1;
		}
		if (((paramString1.equals("戊")) || (paramString1.equals("己")))
				&& ((LuozhuangcommonClass.dizhiwuxing(paramString2).equals("土"))
						|| (((paramString1.equals("庚")) || (paramString1.equals("辛")))
								&& ((paramString2.equals("寅")) || (paramString2.equals("亥")))))) {
			return 1;
		}
		return 0;
	}
	...
	public int wenchang(String paramString1, String paramString2) {
		if ((paramString1.equals("甲")) && (paramString2.equals("巳"))
				|| ((paramString1.equals("乙")) && (paramString2.equals("午")))) {
			return 1;
		}
		if (((paramString1.equals("丙")) || (paramString1.equals("戊"))) && ((paramString2.equals("申"))
				|| ((paramString1.equals("丁"))) || (paramString1.equals("己")) && (paramString2.equals("酉")))) {
			return 1;
		}
		if (((paramString1.equals("庚")) && (paramString2.equals("亥")))
				|| ((paramString1.equals("辛")) && (paramString2.equals("子")))
				|| ((paramString1.equals("壬")) && (paramString2.equals("寅")))) {
			return 1;
		}
	...
	public int yima(String paramString1, String paramString2) {
		if (((paramString1.equals("申")) || (paramString1.equals("子")) || (paramString1.equals("辰")))
				&& (paramString2.equals("寅"))) {
			return 1;
		}
		if (((paramString1.equals("寅")) || (paramString1.equals("午")) || (paramString1.equals("戌")))
				&& ((paramString2.equals("申")))) {
			return 1;
		}

		if (((paramString1.equals("巳")) || (paramString1.equals("酉")) || (paramString1.equals("丑")))
				&& ((paramString2.equals("亥")))) {
			return 1;
		}
		if ((((paramString1.equals("亥")) || (paramString1.equals("卯")) || (paramString1.equals("未")))
				&& (paramString2.equals("巳")))) {
			return 1;
		}
	...
	public int huagai(String paramString1, String paramString2) {
		if (((paramString1.equals("申")) || (paramString1.equals("子")) || (paramString1.equals("辰")))
				&& (paramString2.equals("辰"))) {
			return 1;
		}

		if (((paramString1.equals("寅")) || (paramString1.equals("午")) || (paramString1.equals("戌")))
				&& ((paramString2.equals("戌")))) {
			return 1;
		}

		if (((paramString1.equals("巳")) || (paramString1.equals("酉")) || (paramString1.equals("丑")))
				&& ((paramString2.equals("丑")))) {
			return 1;
		}
		if (((paramString1.equals("亥")) || (paramString1.equals("卯")) || (paramString1.equals("未")))
				&& (paramString2.equals("未"))) {
			return 1;
		}
	...
	public int guluan(String paramString1, String paramString2, String paramString3, String paramString4) {
		if ((paramString1.equals("乙")) && (paramString2.equals("巳"))
				&& (((paramString3.equals("丁")) && (paramString4.equals("巳")))
						|| ((paramString3.equals("辛")) && (paramString4.equals("亥")))
						|| ((paramString3.equals("戊")) && (paramString4.equals("申")))
						|| ((paramString3.equals("壬")) && (paramString4.equals("寅")))
						|| ((paramString3.equals("戊")) && (paramString4.equals("午")))
						|| ((paramString3.equals("壬")) && (paramString4.equals("子")))
						|| ((paramString3.equals("丙")) && (paramString4.equals("午"))))) {
			return 1;
		}

		if (((paramString1.equals("丁")) && (paramString2.equals("巳"))
				&& (((paramString3.equals("乙")) && (paramString4.equals("巳")))
						|| ((paramString3.equals("辛")) && (paramString4.equals("亥")))
						|| ((paramString3.equals("戊")) && (paramString4.equals("申")))
						|| ((paramString3.equals("壬")) && (paramString4.equals("寅")))
						|| ((paramString3.equals("戊")) && (paramString4.equals("午")))
						|| ((paramString3.equals("壬")) && (paramString4.equals("子")))
						|| ((paramString3.equals("丙")) && (paramString4.equals("午")))))
				|| ((paramString1.equals("辛")) && (paramString2.equals("亥"))
						&& (((paramString3.equals("丁")) && (paramString4.equals("巳")))
								|| ((paramString3.equals("乙")) && (paramString4.equals("巳")))
								|| ((paramString3.equals("戊")) && (paramString4.equals("申")))
								|| ((paramString3.equals("壬")) && (paramString4.equals("寅")))
				...
				|| ((paramString1.equals("壬")) && (paramString2.equals("寅"))
						&& (((paramString3.equals("丁")) && (paramString4.equals("巳")))
								...
								|| ((paramString3.equals("壬")) && (paramString4.equals("子")))
								|| ((paramString3.equals("丙")) && (paramString4.equals("午")))))
				|| ((paramString1.equals("戊")) && (paramString2.equals("午"))
						&& (((paramString3.equals("丁")) && (paramString4.equals("巳")))
								|| ((paramString3.equals("辛")) && (paramString4.equals("亥")))
								|| ((paramString3.equals("戊")) && (paramString4.equals("申")))
								|| ((paramString3.equals("壬")) && (paramString4.equals("寅")))
								...
								|| ((paramString3.equals("壬")) && (paramString4.equals("子")))
								|| ((paramString3.equals("丙")) && (paramString4.equals("午")))))
				|| ((paramString1.equals("壬")) && (paramString2.equals("子"))
						&& (((paramString3.equals("丁")) && (paramString4.equals("巳")))
								|| ((paramString3.equals("辛")) && (paramString4.equals("亥")))
								|| ((paramString3.equals("戊")) && (paramString4.equals("申")))
								|| ((paramString3.equals("壬")) && (paramString4.equals("寅")))
	...
	public int shangmen(String paramString1, String paramString2) {
		if ((dizhiOrder(paramString2) - dizhiOrder(paramString1) == 2)
				|| (12 + dizhiOrder(paramString2) - dizhiOrder(paramString1) == 2)) {
			return 1;
		}
		return 0;
	}
	...
	public int diaoke(String paramString1, String paramString2) {
		if ((dizhiOrder(paramString1) - dizhiOrder(paramString2) == 2)
				|| (12 + dizhiOrder(paramString1) - dizhiOrder(paramString2) == 2)) {
			return 1;
		}
		return 0;
	}
	...
	public int pima(String paramString1, String paramString2) {
		if ((dizhiOrder(paramString1) - dizhiOrder(paramString2) == 3)
				|| (12 + dizhiOrder(paramString1) - dizhiOrder(paramString2) == 3)) {
			return 1;
		}
		return 0;
	}
	...
	public int yuancheng(String paramString1, String paramString2, int paramInt1, int paramInt2) {
		if ((paramString1.equals("子")) && (paramString2.equals("未"))
				&& (((paramInt1 == 1) && (paramInt2 == 1)) || ((paramInt1 == 0) && (paramInt2 == 0)))
				|| ((paramString1.equals("丑")) && (paramString2.equals("申"))
						&& (((paramInt1 == 1) && (paramInt2 == 1)) || ((paramInt1 == 0) && (paramInt2 == 0))))
				|| ((paramString1.equals("寅")) && (paramString2.equals("酉"))
						&& (((paramInt1 == 1) && (paramInt2 == 1)) || ((paramInt1 == 0) && (paramInt2 == 0))))
				|| ((paramString1.equals("卯")) && (paramString2.equals("戌"))
						&& (((paramInt1 == 1) && (paramInt2 == 1)) || ((paramInt1 == 0) && (paramInt2 == 0))))
				|| ((paramString1.equals("辰")) && (paramString2.equals("亥"))
						&& (((paramInt1 == 1) && (paramInt2 == 1)) || ((paramInt1 == 0) && (paramInt2 == 0))))
				|| ((paramString1.equals("巳")) && (paramString2.equals("子"))
						&& (((paramInt1 == 1) && (paramInt2 == 1)) || ((paramInt1 == 0) && (paramInt2 == 0))))
				|| ((paramString1.equals("午")) && (paramString2.equals("丑"))
						&& (((paramInt1 == 1) && (paramInt2 == 1)) || ((paramInt1 == 0) && (paramInt2 == 0))))
				|| ((paramString1.equals("未")) && (paramString2.equals("寅"))
						&& (((paramInt1 == 1) && (paramInt2 == 1)) || ((paramInt1 == 0) && (paramInt2 == 0))))
				|| ((paramString1.equals("申")) && (paramString2.equals("卯"))
						&& (((paramInt1 == 1) && (paramInt2 == 1)) || ((paramInt1 == 0) && (paramInt2 == 0))))
				|| ((paramString1.equals("酉")) && (paramString2.equals("辰"))
						&& (((paramInt1 == 1) && (paramInt2 == 1)) || ((paramInt1 == 0) && (paramInt2 == 0))))
				|| ((paramString1.equals("戌")) && (paramString2.equals("巳"))
						&& (((paramInt1 == 1) && (paramInt2 == 1)) || ((paramInt1 == 0) && (paramInt2 == 0))))
				|| ((paramString1.equals("亥")) && (paramString2.equals("午"))
						&& (((paramInt1 == 1) && (paramInt2 == 1)) || ((paramInt1 == 0) && (paramInt2 == 0))))
				|| ((paramString1.equals("子")) && (paramString2.equals("巳"))
						&& (((paramInt1 == 1) && (paramInt2 == 0)) || ((paramInt1 == 0) && (paramInt2 == 1))))
				|| ((paramString1.equals("丑")) && (paramString2.equals("午"))
						&& (((paramInt1 == 1) && (paramInt2 == 0)) || ((paramInt1 == 0) && (paramInt2 == 1))))
				|| ((paramString1.equals("寅")) && (paramString2.equals("未"))
						&& (((paramInt1 == 1) && (paramInt2 == 0)) || ((paramInt1 == 0) && (paramInt2 == 1))))
				|| ((paramString1.equals("卯")) && (paramString2.equals("申"))
						&& (((paramInt1 == 1) && (paramInt2 == 0)) || ((paramInt1 == 0) && (paramInt2 == 1))))
				|| ((paramString1.equals("辰")) && (paramString2.equals("酉"))
						&& (((paramInt1 == 1) && (paramInt2 == 0)) || ((paramInt1 == 0) && (paramInt2 == 1))))
				|| ((paramString1.equals("巳")) && (paramString2.equals("戌"))
						&& (((paramInt1 == 1) && (paramInt2 == 0)) || ((paramInt1 == 0) && (paramInt2 == 1))))
				|| ((paramString1.equals("午")) && (paramString2.equals("亥"))
						&& (((paramInt1 == 1) && (paramInt2 == 0)) || ((paramInt1 == 0) && (paramInt2 == 1))))
				|| ((paramString1.equals("未")) && (paramString2.equals("子"))
						&& (((paramInt1 == 1) && (paramInt2 == 0)) || ((paramInt1 == 0) && (paramInt2 == 1))))
				|| ((paramString1.equals("申")) && (paramString2.equals("丑"))
						&& (((paramInt1 == 1) && (paramInt2 == 0)) || ((paramInt1 == 0) && (paramInt2 == 1))))
				|| ((paramString1.equals("酉")) && (paramString2.equals("寅"))
						&& (((paramInt1 == 1) && (paramInt2 == 0)) || ((paramInt1 == 0) && (paramInt2 == 1))))
				|| ((paramString1.equals("戌")) && (paramString2.equals("卯"))
						&& (((paramInt1 == 1) && (paramInt2 == 0)) || ((paramInt1 == 0) && (paramInt2 == 1))))
				|| ((paramString1.equals("亥")) && (paramString2.equals("辰"))
						&& (((paramInt1 == 1) && (paramInt2 == 0)) || ((paramInt1 == 0) && (paramInt2 == 1))))) {
			return 1;
		}
		return 0;
	...
	public int yuede(String paramString1, String paramString2) {
		if (((paramString1.equals("寅")) || (paramString1.equals("午")) || (paramString1.equals("戌")))
				&& (paramString2.equals("丙"))) {
			return 1;
		}
		if (((paramString1.equals("申")) || (paramString1.equals("子")) || (paramString1.equals("辰")))
				&& ((paramString2.equals("壬")))) {
			return 1;
		}
		if (((paramString1.equals("亥")) || (paramString1.equals("卯")) || (paramString1.equals("未")))
				&& ((paramString2.equals("甲")))) {
			return 1;
		}

		if (((paramString1.equals("巳")) || (paramString1.equals("酉")) || (paramString1.equals("丑")))
				&& (paramString2.equals("庚"))) {
			return 1;
		}
		return 0;
	}
	...
	public int tianshe(String paramString1, String paramString2, String paramString3) {
		if (((paramString1.equals("寅")) || (paramString1.equals("卯")) || (paramString1.equals("辰")))
				&& (paramString2.equals("戊")) && (paramString3.equals("寅"))) {
			return 1;
		}

		if (((paramString1.equals("巳")) || (paramString1.equals("午")) || (paramString1.equals("未")))
				&& (((paramString2.equals("甲")) && (paramString3.equals("午"))))) {
			return 1;
		}

		if (((paramString1.equals("申")) || (paramString1.equals("酉")) || (paramString1.equals("戌")))
				&& (((paramString2.equals("戊")) && (paramString3.equals("申"))))) {
			return 1;
		}

		if (((paramString1.equals("亥")) || (paramString1.equals("子")) || (paramString1.equals("丑")))
				&& (paramString2.equals("甲")) && (paramString3.equals("子"))) {
			return 1;
		}
	...
	public int sifei(String paramString1, String paramString2, String paramString3) {
		if (((paramString1.equals("寅")) || (paramString1.equals("卯")) || (paramString1.equals("辰")))
				&& (((paramString2.equals("庚")) && (paramString3.equals("申")))
						|| ((paramString2.equals("辛")) && (paramString3.equals("酉"))))) {
			return 1;
		}

		if (((paramString1.equals("巳")) || (paramString1.equals("午")) || (paramString1.equals("未")))
				&& (((paramString2.equals("壬")) && (paramString3.equals("子")))
						|| ((paramString2.equals("癸")) && (paramString3.equals("亥"))))) {
			return 1;
		}

		if (((paramString1.equals("申")) || (paramString1.equals("酉")) || (paramString1.equals("戌")))
				&& (((paramString2.equals("甲")) && (paramString3.equals("寅")))
						|| ((paramString2.equals("乙")) && (paramString3.equals("卯"))))) {
			return 1;
		}

		if (((paramString1.equals("亥")) || (paramString1.equals("子")) || (paramString1.equals("丑")))
				&& (((paramString2.equals("丙")) && (paramString3.equals("午")))
						|| ((paramString2.equals("丁")) && (paramString3.equals("巳"))))) {
			return 1;
		}
	...
	public int shiedabai(String paramString1, String paramString2) {
		if (((paramString1.equals("甲")) && (paramString2.equals("辰")))
				|| ((paramString1.equals("乙")) && (paramString2.equals("巳")))
				|| ((paramString1.equals("壬")) && (paramString2.equals("申")))
				|| ((paramString1.equals("丙")) && (paramString2.equals("申")))
				|| ((paramString1.equals("丁")) && (paramString2.equals("亥")))
				|| ((paramString1.equals("庚")) && (paramString2.equals("辰")))
				|| ((paramString1.equals("戊")) && (paramString2.equals("戌")))
				|| ((paramString1.equals("癸")) && (paramString2.equals("亥")))
				|| ((paramString1.equals("辛")) && (paramString2.equals("巳")))
				|| ((paramString1.equals("己")) && (paramString2.equals("丑")))) {
			return 1;
		}
		return 0;
	}
	...
	public static void main(String[] args) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(LuozhuangshengSha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		}
